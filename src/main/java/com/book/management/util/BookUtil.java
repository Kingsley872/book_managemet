...
public class BookUtil {
	...
	public static final String BOOKS_NOT_FOUND_MESSAGE = "I did not found the requested book. Could you please try again?";
	public static final String BOOK_NOT_FOUND_MESSAGE = "No books found based on request. Could you please try again?";
	...
	public static String getRandomListOfBooksMessages() {
	...
	public static String getRandomListOfBooksDetailsMessages() {
		Integer listOfBooksDetailsValue = new Random().nextInt(listOfBookDetailsMessages.size());
		return listOfBookDetailsMessages.get(listOfBooksDetailsValue);
	}
}
