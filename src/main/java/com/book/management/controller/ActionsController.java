...
public class ActionsController {
	...
	@PostMapping
	public ResponseEntity<?> executePostAction(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		case IntentUtil.GET_BOOK_DETAILS_GENRE:
			// invoke bookService -> list_books_by_author intent (business logic)
